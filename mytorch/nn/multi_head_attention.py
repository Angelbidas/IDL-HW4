...
class MultiHeadAttention:
    ...
    def _merge_masks(self, key_padding_mask, attn_mask):
        ...
        combined_mask = key_mask | attention_mask if key_mask is not None and attention_mask is not None else key_mask if key_mask is not None else attention_mask
